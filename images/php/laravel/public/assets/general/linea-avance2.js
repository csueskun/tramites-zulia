...
function setActivo(estadoNum) {
	document.getElementById('numeroindicadorinthrz' + estadoNum).classList.remove('num-indicador-inactivo-interaccion-govco');
	document.getElementById('numeroindicadorinthrz' + estadoNum).classList.add('num-indicador-activo-interaccion-govco');
	document.getElementById('indicadorlineainthrz' + estadoNum).classList.remove('indicador-linea-avance-inactivo-interaccion-govco');
	document.getElementById('indicadorlineainthrz' + estadoNum).classList.add('indicador-linea-avance-activo-interaccion-govco');
	document.getElementById('letrainthrz' + estadoNum).classList.remove('letra-indicador-inactivo-interaccion');
	document.getElementById('letrainthrz' + estadoNum).classList.add('letra-indicador-activo-interaccion');
	if (estadoNum > 4) {
		return;
	}
	document.getElementById('lineavanceinthrz' + estadoNum).classList.remove('progress-bar-activa-interaccion-inactivada-govco');
	document.getElementById('lineavanceinthrz' + estadoNum).classList.add('progress-bar-activa-interaccion-govco');
}

function setTerminado(estadoNum) {
	document.getElementById('numeroindicadorinthrz' + estadoNum).innerHTML = '';
	document.getElementById('indicadorlineainthrz' + estadoNum).innerHTML = '';
	document.getElementById('indicadorlineainthrz' + estadoNum).classList.add('terminado');
	if (estadoNum > 4) {
		return;
	}
	document.getElementById('lineavanceinthrz' + estadoNum).style.width = '100%';
}