                                    ...
                                    <div class="modal-body modal-body-govco" style="margin: 12px 40px !important">
                                                ...
                                                <table class="table table-general fix min" id="requerimientos-table"
                                                    ...
                                                    <tbody data-tramite-field="requerimientos">
                                                        @foreach ($tramite->requerimientos as $requerimiento)
                                                            @if (in_array($requerimiento->vehiculo, ['TODOS', $vehiculo]) && in_array($requerimiento->persona, ['TODOS', $persona]))
                                                                <tr>
                                            ...
                                            <div class="col-lg-8">
                                                <div class="entradas-de-texto-govco col-lg-12 px-2">
                                                    ...
                                                    <div class="container-input-texto-govco">
                                                        <input required type="text" name="nombres" id="nombres"
                                                            aria-required="true" class="@error('nombres') error @enderror"
                                                            value="{{ old('nombres') }}">
                                                    ...
                                                    @error('nombres')
                                                        <span class="error-texto-govco alert-entradas-de-texto-govco"
                                                            role="alert" aria-live="assertive">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="entradas-de-texto-govco col-lg-12 px-2">
                                                    ...
                                                    <div class="desplegable-govco @error('tipo_documento') error-desplegable-govco @enderror"
                                                        ...
                                                        <select required aria-invalid="false" aria-describedby="alert-id"
                                                ...
                                                <div class="entradas-de-texto-govco col-lg-12 px-2">
                                                    ...
                                                    <div class="container-input-texto-govco">
                                                        <input type="text" name="identificacion" id="identificacion"
                                                            placeholder="Ejemplo: 1234567890" aria-required="true"
                                            ...
                                            <div class="container-carga-de-archivo-govco mb-4">
                                                <div class="loader-carga-de-archivo-govco">
                                                    <div class="all-input-carga-de-archivo-govco">
                                                        <input required="required" type="file" name="documento_identidad"
                                                            id="documento_identidad"
                                                            class="input-carga-de-archivo-govco active" data-error="0"
                                                            data-action="uploadFileDocumentoIdentidad"
                                                            data-action-delete="deleteFileDocumentoIdentidad" multiple />
                                                        <label for="documento_identidad"
                                                            class="label-carga-de-archivo-govco">Documento de
                                                            identidad*</label>
                                                        <label for="documento_identidad"
                                                            class="container-input-carga-de-archivo-govco">
                                                            <span class="button-file-carga-de-archivo-govco">Seleccionar
                                                                archivo</span>
                                                            <span class="file-name-carga-de-archivo-govco">Sin archivo
                                                                seleccionado</span>
                                                        </label>
                                                        <span class="text-validation-carga-de-archivo-govco">Cualquier tipo
                                                            de archivo. Peso máximo: 2 MB</span>
                                                    </div>
                                                    <div class="load-button-carga-de-archivo-govco" style="display: none;">
                                                        <div class="load-carga-de-archivo-govco">
                                                            <div class="spinner-indicador-de-carga-govco"
                                                                style="width: 32px; height: 32px; border-width: 6px;"
                                                                role="status">
                                                                <span class="visually-hidden">Cargando...</span>
                                                            </div>
                                                        </div>
                                                        <button id="documento_identidad_load"
                                                            class="button-loader-carga-de-archivo-govco" disabled>Cargar
                                                            archivo</button>
                                                    </div>
                                                </div>
                                                <div class="container-detail-carga-de-archivo-govco">
                                                    <span id="documento_identidad_error"
                                                        class="alert-carga-de-archivo-govco visually-hidden"></span>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="container-carga-de-archivo-govco mb-4">
                                                <div class="loader-carga-de-archivo-govco">
                                                    <div class="all-input-carga-de-archivo-govco">
                                                        <input required="required" type="file" name="documento_fun"
                                                            id="documento_fun" class="input-carga-de-archivo-govco active"
                                                            data-error="0" data-action="uploadFileDocumentoFun"
                                                            data-action-delete="deleteFileDocumentoFun" multiple />
                                                        <label for="documento_fun"
                                                            class="label-carga-de-archivo-govco">Documento FUN*</label>
                                                        <label for="documento_fun"
                                                            class="container-input-carga-de-archivo-govco">
                                                            <span class="button-file-carga-de-archivo-govco">Seleccionar
                                                                archivo</span>
                                                    ...
                                                    <div class="load-button-carga-de-archivo-govco" style="display: none;">
                                                        ...
                                                        <button id="documento_fun_load"
                                                            class="button-loader-carga-de-archivo-govco" disabled>Cargar
                                                            archivo</button>
                                                    </div>
                                                </div>
                                                <div class="container-detail-carga-de-archivo-govco">
                                                    <span id="documento_fun_error"
                                                        class="alert-carga-de-archivo-govco visually-hidden"></span>
                                                    <div class="attached-files-carga-de-archivo-govco"></div>
                                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="container-carga-de-archivo-govco">
                                                <div class="loader-carga-de-archivo-govco">
                                                    <div class="all-input-carga-de-archivo-govco">
                                                        <input required="required" type="file" name="documento_propiedad"
                                                            id="documento_propiedad"
                                                            class="input-carga-de-archivo-govco active" data-error="0"
                                                            data-action="uploadFileDocumentoPropiedad"
                                                            data-action-delete="deleteFileDocumentoPropiedad" multiple />
                                                        <label for="documento_propiedad"
                                                            class="label-carga-de-archivo-govco">Tarjeta de
                                                            Propiedad*</label>
                                                        <label for="documento_propiedad"
                                                            class="container-input-carga-de-archivo-govco">
                                                            <span class="button-file-carga-de-archivo-govco">Seleccionar
                                                    ...
                                                    <div class="load-button-carga-de-archivo-govco" style="display: none;">
                                                        ...
                                                        <button id="documento_propiedad_load"
                                                            class="button-loader-carga-de-archivo-govco" disabled>Cargar
                                                            archivo</button>
                                                    </div>
                                                </div>
                                                <div class="container-detail-carga-de-archivo-govco">
                                                    <span id="documento_propiedad_error"
                                                        class="alert-carga-de-archivo-govco visually-hidden"></span>
                                                    <div class="attached-files-carga-de-archivo-govco"></div>
                                                </div>
                                        ...
                                        <div class="col-lg-12 d-none" id="archivo_adicional">
                                            <div class="container-carga-de-archivo-govco">
                                                <div class="loader-carga-de-archivo-govco">
                                                    <div class="all-input-carga-de-archivo-govco">
                                                        <input type="file" name="documento_poder" id="documento_poder"
                                                            class="input-carga-de-archivo-govco active" data-error="0"
                                                            data-action="uploadFilePoder"
                                                            data-action-delete="deleteFilePoder" multiple />
                                                        <label for="documento_poder"
                                                            class="label-carga-de-archivo-govco">Documento poder*</label>
                                                        <label for="documento_poder"
                                                            class="container-input-carga-de-archivo-govco">
                                                            <span class="button-file-carga-de-archivo-govco">Seleccionar
                                                                archivo</span>
                                                    ...
                                                    <div class="load-button-carga-de-archivo-govco" style="display: none;">
                                                        ...
                                                        <button id="documento_poder_load"
                                                            class="button-loader-carga-de-archivo-govco" disabled>Cargar
                                                            archivo</button>
                                                    </div>
                                                </div>
                                                <div class="container-detail-carga-de-archivo-govco">
                                                    <span id="documento_poder_error"
                                                        class="alert-carga-de-archivo-govco visually-hidden"></span>
                                                    <div class="attached-files-carga-de-archivo-govco"></div>
                                                </div>
