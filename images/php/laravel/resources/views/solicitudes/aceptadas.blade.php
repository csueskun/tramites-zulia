...
<div class="modal fade" id="enviar-recibo" role="dialog" aria-labelledby="enviar-recibo" aria-hidden="true">
    <div class="container-modal-govco" id="modal_enviar_recibo">
        <div class="modal-container-govco" id="enviarReciboModalContainer" tabindex="-1" data-bs-backdrop="false"
            data-bs-keyboard="false" aria-labelledby="enviar-recibo" aria-hidden="true" role="dialog">
            <div class="modal-dialog modal-dialog-govco modal-lg">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-content modal-content-govco">
                        <div class="modal-header modal-header-govco">
                            <a href="javascript:void(0)" role="button" data-bs-dismiss="modal" class="close-btn-modal"
                                aria-label="Close" aria-expanded="false" onclick="closeModal('modal_enviar_recibo')">
                                <span class="modal-close-govco govco-times"></span>
                            </a>
                        </div>
                        <div class="modal-body modal-body-govco">
                            <h3 class="modal-title-govco mb-4">Enviar recibo de pago</h3>
                            <div class="row">
                                <div class="col-lg-12">
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-content modal-content-govco">
                        ...
                        <div class="modal-body modal-body-govco">
                            ...
                            <p class="modal-text-govco text-center">Por favor escriba el motivo del rechazo de la solicitud.</p>
                            <div class="row my-4">
...
<div class="modal fade" id="enviar-cupl" role="dialog" aria-labelledby="enviar-cupl" aria-hidden="true">
    <div class="container-modal-govco" id="modal_enviar_cupl">
        <div class="modal-container-govco" id="enviarCuplModalContainer" tabindex="-1" data-bs-backdrop="false"
            data-bs-keyboard="false" aria-labelledby="enviar-cupl" aria-hidden="true" role="dialog">
            <div class="modal-dialog modal-dialog-govco modal-lg">
                <form action="" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content modal-content-govco">
